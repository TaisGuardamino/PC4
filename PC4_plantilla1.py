...
st.markdown("<h1 style='text-align: center;'>Python me cambió la vida🙇</h1>", unsafe_allow_html=True)
...
col1.image("foto4.jpeg", caption='Tais', width=300)
...
texto = """
Soy Tais, estudiante de publicidad en sexto ciclo. Antes no sabía nada sobre programar. Ahora tampoco sé mucho, pero algo es algo.
"""
...
texto_2 = """
El primer día no entendí nada. El segundo día tampoco. Al tercer día entendí un poquito más, y así progresivamente. Realmente creí que sería más difícil, pero poco a poco le agarré el gusto.
"""
...
sidebar.markdown("<h1 style='text-align: center;'>Gráficos desarrollados🤓☝️</h1>", unsafe_allow_html=True)
...
graficos = ['Gráfico de lenguas', 'Gráfico familia quechua', 'Gráfico de películas']
...
if grafico_seleccionado == 'Gráfico de lenguas':
    sidebar.markdown("<div style='text-align: justify; font-size: 20px;'>En este gráfico se puede visualizar la cantidad de lenguas por familia lingüística, siendo la familia Awakaran aquella con la mayor cantidad de lenguas.</div>", unsafe_allow_html=True)
    sidebar.image("foto1.png", caption='Gráfico de lenguas', width=500)
    pass
elif grafico_seleccionado == 'Gráfico familia quechua':
    sidebar.markdown("<div style='text-align: justify; font-size: 20px;'>Gráfico de la ubicación de las lenguas de la familia lingüística Quechuan.</div>", unsafe_allow_html=True)
    sidebar.image("foto3.png", caption='Gráfico familia quechua', width=500)
    pass
elif grafico_seleccionado == 'Gráfico de películas':
    sidebar.markdown("<div style='text-align: justify; font-size: 20px;'>En este gráfico se pueden visualizar las ubicaciones en donde fueron filmadas mis 5 películas favoritas: Los Muppets, Chicago, Lalaland, Parasite y Lady Bird.</div>", unsafe_allow_html=True)
    sidebar.image("foto2.png", caption='Gráfico de películas', width=500)
    pass
